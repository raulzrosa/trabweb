...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'get /deletauser' : 'UserController.deletauser',
  'post /associargrupo' : 'GroupController.associarPessoa',
  'post /desassociarGrupo' : 'GroupController.desassociargrupo',
  'post /segueUsuario' : 'UserController.segueusuario',
  'post /pararDeSeguirUsuario' : 'UserController.parardeseguirusuario',
  'post /curtirPost' : 'UserController.curtirpost',
  'post /descurtirPost' : 'UserController.descurtirpost',
  'get /getPostSigo' : 'LoginController.getPostSigo',
  'get /exportaDados.json' : 'ExportController.exportadados',
  'post /importaDados' : 'ImportController.importadados'
  /***************************************************************************
  *                                                                          *
  * Custom routes here...                                                    *
  *                                                                          *
